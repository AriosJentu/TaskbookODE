\subsection{Задачи}
	...
	\begin{multicols}{2}
		\begin{enumtasks}
			...
			\item \( 3 \pares{xy^2 y' \ln{x} - 1} = y^3 + x \log{x} + x \)												% y^3 = C \ln{x} + x + 3
	...
	\begin{enumtasks}
		...
		\item \( xy' \pares{x - 1} = \pares{x + 1} \cdot \pares{x \sqrt{y} + y} + 4x \sqrt{y} \)					% \sqrt{y} = \frac{C \pares{1 - x}}{\sqrt{x}} + x
		\item \( \pares{2 xy^2 + y'} \cdot \ln{\pares{x^2 + 1}} + 2xy^2 + \frac{2xy}{x^2 + 1} = 0 \)				% \frac{1}{y} = C \ln{\pares{x^2 + 1}} + x^2 + 1
		\item \( 2y' \pares{y + 1} \arctan{x} - 1 = 2x \arctan{x} + \frac{\pares{y + 1}^2}{x^2 + 1} \)				% \pares{y + 1}^2 = C \arctan{x} + x^2 + 1
	...
	\begin{enumtasks}
		...
		\itemstar \( y' x \ln{x} + y + y^2 = 2 \pares{y + 1} \ln{x} - \ln^2{x} \) 									% y = \frac{1}{C \ln{x} - 1} + \ln{x}
